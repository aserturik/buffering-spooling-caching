              ...
              <div className="timeline-item">
                ...
                <div>
                  ...
                  >
                    ...
                    ejecución. Si el trabajo tardaba horas, la máquina completa
                    esperaba. No existía multiprogramación real.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div>
                  ...
                  >
                    ...
                    intermediarios: recibían tarjetas perforadas, las agrupaban,
                    y las entregaban físicamente a la impresora. El "spool" era
                    una <em>cinta magnética</em> física.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <p style={{ fontSize: "1.7rem !important", margin: 0 }}>
                    ...
                    El scheduler IPP gestiona prioridades, reintentos y colas
                    por red.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <p style={{ fontSize: "1.7rem !important", margin: 0 }}>
                    <strong>spoolsv.exe</strong> orquesta drivers en espacio de
                    usuario (post-PrintNightmare). Soporte nativo para{" "}
