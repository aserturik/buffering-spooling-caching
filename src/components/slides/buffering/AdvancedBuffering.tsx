      ...
      <div style={{ padding: "0 5%" }}>
        ...
        <div className="grid-2" style={{ gap: "3rem" }}>
          <div className="technical-note" style={{ background: "rgba(79, 195, 247, 0.05)", borderColor: "var(--accent-spool)" }}>
            <h4 style={{ color: "var(--accent-spool)", fontSize: "1.8rem" }}>Evitando el Colapso</h4>
          ...
          <div style={{ textAlign: "left" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem" }}>
              <div className="presenter-tag" style={{ fontSize: "1.7rem" }}>1. Syscall read()</div>
              <div style={{ paddingLeft: "2rem" }}><ArrowRight size={16} /> <span style={{ color: "var(--accent-buf)" }}>¿Dato en Kernel Buffer?</span></div>
              <div className="presenter-tag" style={{ fontSize: "1.7rem", background: "rgba(168, 224, 99, 0.1)", color: "var(--accent-cache)" }}>SÍ: Copia directa a App RAM (Rápido)</div>
              <div className="presenter-tag" style={{ fontSize: "1.7rem", background: "rgba(255, 107, 107, 0.1)", color: "var(--accent-red)" }}>NO: Leer de Disco → Llenar Buffer → Copiar</div>
            </div>
          </div>
        </div>
      </div>
